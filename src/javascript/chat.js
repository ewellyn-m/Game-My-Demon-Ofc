...
const outroPersonagem = new Personagem("Outro Personagem");
...
const dialogo = [
    ...
    { nome: "", texto: "Era so o que me faltava... escuta aqui, fala logo o que voce quer e me manda de volta para casa A G O R A", 
    escolhas: [
    ...
    { nome: "Outro personagem", texto: "Ótimo! Vamos lá.", escolhas: [] },
];
...
} else if (caminho === 4) { // Resposta "geladeira"
const gamerContainer = document.querySelector('.gamer-container');
gamerContainer.style.backgroundImage = "url(../imagens/cenarios/cozinha.jpg)"; // Substitua com o caminho da sua nova imagem
exibirDialogo(caminho); // Exibe o próximo diálogo
} else if (caminho === 14) { // Resposta "Desço as escadas para o porão..."
const gamerContainer = document.querySelector('.gamer-container');
gamerContainer.style.backgroundImage = "url(../imagens/cenarios/porao.avif)"; // Substitua com o caminho da sua nova imagem
exibirDialogo(caminho); // Exibe o próximo diálogo
} else {
const extraImagem = document.getElementById('extra-imagem');
